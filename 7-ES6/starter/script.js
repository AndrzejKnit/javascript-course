...
ages6 = years.map((el, index) => {
    ...
    const age = now - el;
    return `Age element ${index + 1}: ${age}. ${el}`
});
console.log(ages6);
*/
...
const boxes = document.querySelectorAll('.box');
const all = [h, ...boxes];                           // spread '...' jest używany w call function
...
const allStreets = [new Street('Ocean Avenie', 1999, 1.1, 1),
...
function reportStreets(s) {
    ...
    console.log(`Our ${s.length} streets have a total length of ${totalLenth}
